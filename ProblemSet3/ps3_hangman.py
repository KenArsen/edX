...
def getGuessedWord(secretWord, lettersGuessed):
    ...
    # FILL IN YOUR CODE HERE...
    for i in secretWord:
        if i != '_' and i not in lettersGuessed:
    ...
    * After each round, you should also display to the user the 
    ...
    while mistakesMade > 0:
        ...
        if word in lettersGuessed:
            ...
            gussedWord = getGuessedWord(secretWord, lettersGuessed)
            if word in secretWord:
                print("Good guess: ",  gussedWord)
            else:
                print("Oops! That letter is not in my word: ", gussedWord)
                mistakesMade -= 1
            if isWordGuessed(gussedWord, lettersGuessed):
                print("------------")
